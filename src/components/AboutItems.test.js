...
import AboutItems from './AboutItems.test.js'
...
describe('<AboutItems />', () => {
    ...
    it('Plastic Pollution: <AboutItems />:Object is an instance of this class; Matches user instance', () => {
        wrapper = shallow(<About />);
        expect(()=> wrapper.toBeInstanceOf(About));
    });
    /* Checks that a variable is not undefined, or checks function and returns true */
    it('Plastic Pollution: <AboutItems />:Rendered correct defined variables and functions', () => {
        wrapper = shallow(<About />);
        expect(wrapper.find(About)).toBeDefined();
    });
    /* Checks length of object, must be greater then 0*/
    it('Plastic Pollution: <AboutItems />:Class object has existing length', () => {
        wrapper = shallow(<About />);
        expect(wrapper.find(About)).toHaveLength(About.length);
    });
    /* If we rendered an object to screen, return true*/
    it('Plastic Pollution: <AboutItems />:Rendered object correctly to screen!', () => {
        wrapper = shallow(<About />);
    ...
    it('Plastic Pollution: <AboutItems />:Rendered object matches subset properties!', () => {
        wrapper = shallow(<About />);
        expect(wrapper.find(About)).toMatchObject(AboutItems);
    });
    ...
    it('Checking Local Server Links: Rendered correctly', () => {
        ...
        /* Only activiated if checking for properties. About does not pass properties to any child components*/
        // it('Plastic Pollution: <AboutItems /> must render length of object if not authenticated!', () => {
